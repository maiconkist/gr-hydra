...
# Generated: Tue Mar 12 19:01:20 2019
##################################################
...
class ansible_hydra_vr2_rx(gr.top_block):
    ...
    def __init__(self, freqrx=2.32e9, freqtx=2.32e9+3e6, gain=0.85, mul=0.06, samp_rate=200e3, vr1offset=-300e3, vr2offset=700e3):
