...
# Generated: Tue Mar 12 13:13:08 2019
##################################################
...
class ansible_hydra_gr_client_2tx_2rx(gr.top_block):
    ...
    def __init__(self, ansibleIP='192.168.5.73', freqrx=2.22e9+3e6, freqtx=2.22e9, mul=0.06, samp_rate=200e3, vr1offset=-300e3, vr2offset=700e3):
        ...
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_gr_complex*1, 'VR1 RX', ""); self.blocks_tag_debug_0.set_display(True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_tagged_stream_to_pdu_0, 'pdus'), (self.blocks_message_debug_0_0, 'print_pdu'))
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_tag_debug_0, 0))
