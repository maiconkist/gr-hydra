...
# Generated: Tue May 21 13:03:50 2019
##################################################
...
class ansible_hydra_gr_client_2tx_2rx(gr.top_block):
    ...
    def __init__(self, ansibleIP='192.168.5.235', freqrx=2.43e9+3e6, freqtx=2.43e9, mul=0.04, mul2=0.08, samp_rate=400e3, samp_rate2=200e3, vr1offset=-300e3, vr2offset=300e3):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ansibleIP", dest="ansibleIP", type="string", default='192.168.5.235',
