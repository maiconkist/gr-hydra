...
# Generated: Wed Mar 13 01:18:31 2019
##################################################
...
class ansible_hydra_vr1_rx(gr.top_block):
    ...
    def __init__(self, freqrx=1.42e9, freqtx=1.42e9+3e6, gain=0.7, mul=0.04, samp_rate=200e3, vr1offset=-300e3, vr2offset=700e3):
        ...
        self.blocks_tuntap_pdu_1_0 = blocks.tuntap_pdu('tap0', 1500, False)
