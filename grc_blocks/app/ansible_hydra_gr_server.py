...
# Generated: Tue Mar 12 19:33:17 2019
##################################################
...
class ansible_hydra_gr_server(gr.top_block):
    ...
    def __init__(self, ansibleIPPort='192.168.5.237:5000', freqrx=1.42e9+3e6, freqtx=1.42e9):
...
def argument_parser():
    ...
    parser.add_option(
        "", "--freqrx", dest="freqrx", type="eng_float", default=eng_notation.num_to_str(1.42e9+3e6),
        help="Set freqrx [default=%default]")
    parser.add_option(
        "", "--freqtx", dest="freqtx", type="eng_float", default=eng_notation.num_to_str(1.42e9),
